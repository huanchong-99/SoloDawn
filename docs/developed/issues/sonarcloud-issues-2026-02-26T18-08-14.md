...
- **Maintainability**: 213 个
- **Reliability**: 55 个
- **Security**: 1 个

### 按属性分类

- **Intentionality**: 129 个
- **Consistency**: 99 个
- **Adaptability**: 41 个
...
### 18.1 Refactor this function to reduce its Cognitive Complexity from 18 to the 15 allowed.
...
### 18.2 Refactor this function to reduce its Cognitive Complexity from 20 to the 15 allowed.
...
### 19.1 Refactor this function to reduce its Cognitive Complexity from 22 to the 15 allowed.
...
### 20.1 Unexpected negated condition.
...
### 20.2 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 20.3 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 21.1 Move this component definition out of the parent component and pass data as props.
...
### 21.2 Move this component definition out of the parent component and pass data as props.
...
### 22.1 Unexpected negated condition.
...
### 22.2 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 22.3 Use <input type="button">, <input type="image">, <input type="reset">, <input type="submit">, or <button> instead of the "button" role to ensure accessibility across all devices.
...
### 22.4 `tabIndex` should only be declared on interactive elements.
...
### 22.5 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 22.6 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 23.1 Refactor this function to reduce its Cognitive Complexity from 16 to the 15 allowed.
...
### 23.2 Complete the task associated to this "TODO" comment.
...
### 23.3 Complete the task associated to this "TODO" comment.
...
### 23.4 Extract this nested ternary operation into an independent statement.
...
### 25.1 Move this component definition out of the parent component and pass data as props.
...
### 26.1 This assertion is unnecessary since it does not change the type of the expression.
...
### 26.2 Remove this use of the "void" operator.
...
### 26.3 Remove this use of the "void" operator.
...
### 26.4 Promise-returning function provided to property where a void return was expected.
...
### 27.1 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 28.1 Move this component definition out of the parent component and pass data as props.
...
### 29.1 Complete the task associated to this "TODO" comment.
...
### 30.1 Mark the props of the component as read-only.
...
### 31.1 Mark the props of the component as read-only.
...
### 32.1 Mark the props of the component as read-only.
...
### 32.3 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 32.4 Mark the props of the component as read-only.
...
### 32.5 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 32.6 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 32.7 Mark the props of the component as read-only.
...
### 34.1 Remove this use of the "void" operator.
...
### 35.1 Unexpected negated condition.
...
### 36.2 Use <input type="button">, <input type="image">, <input type="reset">, <input type="submit">, or <button> instead of the "button" role to ensure accessibility across all devices.
...
### 36.3 `tabIndex` should only be declared on interactive elements.
...
### 37.1 Refactor this function to reduce its Cognitive Complexity from 23 to the 15 allowed.
...
### 37.2 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 37.3 Use <input type="button">, <input type="image">, <input type="reset">, <input type="submit">, or <button> instead of the "button" role to ensure accessibility across all devices.
...
### 37.4 `tabIndex` should only be declared on interactive elements.
...
### 37.5 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 37.6 Use <input type="button">, <input type="image">, <input type="reset">, <input type="submit">, or <button> instead of the "button" role to ensure accessibility across all devices.
...
### 37.7 `tabIndex` should only be declared on interactive elements.
...
### 38.1 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 38.2 Use <input type="button">, <input type="image">, <input type="reset">, <input type="submit">, or <button> instead of the "button" role to ensure accessibility across all devices.
...
### 38.3 `tabIndex` should only be declared on interactive elements.
...
### 39.2 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 39.3 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 40.1 useState call is not destructured into value + setter pair
...
### 41.1 Mark the props of the component as read-only.

- **问题ID**: `AZyawmHOHAoMhSap2Yiv`
- **项目**: huanchong-99
- **行号**: L1165
- **类型**: Code Smell
- **严重程度**: Minor
...
### 43.2 Mark the props of the component as read-only.

- **问题ID**: `AZyaid5Vz6bl7h2nphX3`
- **项目**: huanchong-99
- **行号**: L1015
- **类型**: Code Smell
- **严重程度**: Minor
...
### 43.3 Mark the props of the component as read-only.

- **问题ID**: `AZyaid5Vz6bl7h2nphX4`
- **项目**: huanchong-99
- **行号**: L1375
- **类型**: Code Smell
- **严重程度**: Minor
...
### 43.4 Mark the props of the component as read-only.

- **问题ID**: `AZyaid5Vz6bl7h2nphX5`
- **项目**: huanchong-99
- **行号**: L2075
- **类型**: Code Smell
- **严重程度**: Minor
...
### 43.5 Mark the props of the component as read-only.

- **问题ID**: `AZyaid5Vz6bl7h2nphX6`
- **项目**: huanchong-99
- **行号**: L2615
- **类型**: Code Smell
- **严重程度**: Minor
...
### 43.6 Mark the props of the component as read-only.

- **问题ID**: `AZyaid5Vz6bl7h2nphX7`
- **项目**: huanchong-99
- **行号**: L3415
- **类型**: Code Smell
- **严重程度**: Minor
...
### 45.1 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 45.2 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 46.1 Provide multiple methods instead of using "isDisabled" to determine which action to take.
...
### 47.2 Move this component definition out of the parent component and pass data as props.

- **问题ID**: `AZya6BDLhNI1bV4F5DXO`
- **项目**: huanchong-99
- **行号**: L2465
- **类型**: Code Smell
- **严重程度**: Major
...
### 49.1 Move this component definition out of the parent component and pass data as props.
...
### 50.1 Refactor this function to reduce its Cognitive Complexity from 26 to the 15 allowed.
...
### 50.2 Unexpected negated condition.
...
### 50.3 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 51.1 Extract this nested ternary operation into an independent statement.
...
### 51.2 Extract this nested ternary operation into an independent statement.
...
### 52.1 Prefer `String#replaceAll()` over `String#replace()`.
...
### 52.2 Mark the props of the component as read-only.
...
### 52.3 Extract this nested ternary operation into an independent statement.
...
### 52.4 Unexpected negated condition.
...
### 53.1 Make this public static property readonly.
...
### 54.1 Unexpected negated condition.
...
### 55.1 'msg' will use Object's default stringification format ('[object Object]') when stringified.
...
### 56.1 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 56.2 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 57.1 Simplify this regular expression to reduce its complexity from 22 to the 20 allowed.
...
### 57.2 Compare with `undefined` directly instead of using `typeof`.
...
### 57.3 This assertion is unnecessary since it does not change the type of the expression.
...
### 58.1 Use <input type="button">, <input type="image">, <input type="reset">, <input type="submit">, or <button> instead of the "button" role to ensure accessibility across all devices.
...
### 58.2 Extract this nested ternary operation into an independent statement.
...
### 59.2 Refactor this function to reduce its Cognitive Complexity from 20 to the 15 allowed.
...
### 59.3 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 59.4 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 59.5 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 60.1 Comments inside children section of tag should be placed inside braces
...
### 61.1 This assertion is unnecessary since it does not change the type of the expression.
...
### 61.2 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 61.3 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 62.1 Compare with `undefined` directly instead of using `typeof`.
...
### 63.1 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 63.2 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 65.2 Extract this nested ternary operation into an independent statement.
...
### 66.1 Remove this redundant type alias and replace its occurrences with "string".
...
### 66.2 `String.raw` should be used to avoid escaping `\`.
...
### 66.3 The array passed as the value prop to the Context provider changes every render. To fix this consider wrapping it in a useMemo hook.
...
### 72.1 Mark the props of the component as read-only.
...
### 75.1 `String.raw` should be used to avoid escaping `\`.
...
### 79.1 Prefer `.at(…)` over `[….length - index]`.
...
### 79.2 Prefer `.at(…)` over `[….length - index]`.
...
### 79.3 Prefer negative index over length minus index for `slice`.
...
### 79.4 Unexpected negated condition.
...
### 79.5 Refactor this code to not use nested template literals.
...
### 79.6 Mark the props of the component as read-only.
...
### 81.1 useState call is not destructured into value + setter pair
...
### 82.1 Consider removing 'undefined' type or '?' specifier, one of them is redundant.
...
### 86.1 Mark the props of the component as read-only.
...
### 92.1 Extract this nested ternary operation into an independent statement.
...
### 92.2 Using `join()` for entries.map((line) => line.content) may use Object's default stringification format ('[object Object]') when stringified.
...
### 92.3 This assertion is unnecessary since it does not change the type of the expression.
...
### 92.4 Refactor this code to not nest functions more than 4 levels deep.
...
### 92.5 Refactor this code to not nest functions more than 4 levels deep.
...
### 93.1 Do not use an object literal as default for parameter `options`.
...
### 94.1 Simplify this regular expression to reduce its complexity from 22 to the 20 allowed.
...
### 94.2 Compare with `undefined` directly instead of using `typeof`.
...
### 94.3 This assertion is unnecessary since it does not change the type of the expression.
...
### 95.1 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 96.1 Unexpected negated condition.
...
### 96.2 The signature '(callback: ((this: MediaQueryList, ev: MediaQueryListEvent) => any) | null): void' of 'mql.addListener' is deprecated.
...
### 96.3 The signature '(callback: ((this: MediaQueryList, ev: MediaQueryListEvent) => any) | null): void' of 'mql.removeListener' is deprecated.
...
### 97.1 Extract this nested ternary operation into an independent statement.
...
### 98.1 This assertion is unnecessary since it does not change the type of the expression.
...
### 99.1 Prefer `.at(…)` over `[….length - index]`.
...
### 100.1 This assertion is unnecessary since it does not change the type of the expression.
...
### 100.2 This assertion is unnecessary since it does not change the type of the expression.
...
### 100.3 This assertion is unnecessary since it does not change the type of the expression.
...
### 100.4 This assertion is unnecessary since it does not change the type of the expression.
...
### 100.5 This assertion is unnecessary since it does not change the type of the expression.
...
### 100.6 This assertion is unnecessary since it does not change the type of the expression.
...
### 100.7 This assertion is unnecessary since it does not change the type of the expression.
...
### 100.8 This assertion is unnecessary since it does not change the type of the expression.
...
### 101.1 Prefer `throw error` over `return Promise.reject(error)`.
...
### 102.1 Complete the task associated to this "TODO" comment.
...
### 102.2 Complete the task associated to this "TODO" comment.
...
### 102.3 This assertion is unnecessary since it does not change the type of the expression.
...
### 102.4 Complete the task associated to this "TODO" comment.
...
### 103.1 Unexpected negated condition.
...
### 103.2 useState call is not destructured into value + setter pair
...
### 103.3 Unexpected negated condition.
...
### 104.1 Remove this useless assignment to variable "url".
...
### 105.1 This assertion is unnecessary since it does not change the type of the expression.
...
### 106.1 Prefer using nullish coalescing operator (`??`) instead of a ternary expression, as it is simpler to read.
...
### 106.2 Unexpected negated condition.
...
### 107.1 This assertion is unnecessary since it does not change the type of the expression.
...
### 107.2 This assertion is unnecessary since it does not change the type of the expression.
...
### 108.1 This assertion is unnecessary since it does not change the type of the expression.
...
### 108.2 Prefer `.at(…)` over `[….length - index]`.
...
### 108.3 This assertion is unnecessary since it does not change the type of the expression.
...
### 108.4 Prefer `.at(…)` over `[….length - index]`.
...
### 109.1 Don't use a zero fraction in the number.
...
### 110.1 Remove this useless assignment to variable "user".
...
### 112.1 Move function 'mapTerminalStatus' to the outer scope.
...
### 113.1 'init.body' may use Object's default stringification format ('[object Object]') when stringified.
...
### 114.1 Refactor this function to reduce its Cognitive Complexity from 23 to the 15 allowed.
...
### 115.1 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 115.2 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 115.3 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 115.4 'profilesError' will use Object's default stringification format ('[object Object]') when stringified.
...
### 116.1 Prefer `String#codePointAt()` over `String#charCodeAt()`.
...
### 117.1 This assertion is unnecessary since the receiver accepts the original type of the expression.
...
### 118.3 Mark the props of the component as read-only.
...
### 118.4 Promise-returning function provided to property where a void return was expected.
...
### 119.1 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 119.2 Visible, non-interactive elements with click handlers must have at least one keyboard listener.
...
### 120.1 Type literal has only a call signature, you should use a function type instead.
...
### 121.1 Extract this nested ternary operation into an independent statement.
...
### 121.2 `statuses` should be a `Set`, and use `statuses.has()` to check existence or non-existence.
...
### 121.3 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 121.4 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 121.5 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 121.6 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 121.7 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 121.8 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 123.1 Move this array "reverse" operation to a separate statement or replace it with "toReversed".
...
### 124.1 Refactor this function to reduce its Cognitive Complexity from 16 to the 15 allowed.
...
### 125.1 Prefer using an optional chain expression instead, as it's more concise and easier to read.
...
### 126.1 Prefer `.findLast(…)` over `.filter(…).pop()`.
...
### 127.1 Review this redundant assignment: "cut" already holds the assigned value along all execution paths.
...
### 127.2 Review this redundant assignment: "paste" already holds the assigned value along all execution paths.
...
### 127.3 This assertion is unnecessary since it does not change the type of the expression.
...
### 127.4 Avoid non-native interactive elements. If using native HTML is not possible, add an appropriate role and support for tabbing, mouse, keyboard, and touch inputs to an interactive content element.
...
### 128.2 This assertion is unnecessary since it does not change the type of the expression.
...
### 128.4 This assertion is unnecessary since it does not change the type of the expression.
...
### 128.5 Replace this union type with a type alias.
...
### 128.6 Unexpected negated condition.
...
### 128.7 This assertion is unnecessary since it does not change the type of the expression.
...
### 128.8 Verify the origin of the received message.
...
### 128.9 This assertion is unnecessary since it does not change the type of the expression.
...
### 128.10 This assertion is unnecessary since it does not change the type of the expression.
...
### 129.1 Add an explicit return statement at the end of the function.
