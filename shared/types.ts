...
export enum BaseCodingAgent { CLAUDE_CODE = "CLAUDE_CODE", AMP = "AMP", CODEX = "CODEX", OPENCODE = "OPENCODE", CURSOR_AGENT = "CURSOR_AGENT", QWEN_CODE = "QWEN_CODE", COPILOT = "COPILOT", DROID = "DROID" }

export type CodingAgent = { "CLAUDE_CODE": ClaudeCode } | { "AMP": Amp } | { "CODEX": Codex } | { "OPENCODE": Opencode } | { "CURSOR_AGENT": CursorAgent } | { "QWEN_CODE": QwenCode } | { "COPILOT": Copilot } | { "DROID": Droid };
...
export type ExecutorConfig = { [key in string]?: { "CLAUDE_CODE": ClaudeCode } | { "AMP": Amp } | { "CODEX": Codex } | { "OPENCODE": Opencode } | { "CURSOR_AGENT": CursorAgent } | { "QWEN_CODE": QwenCode } | { "COPILOT": Copilot } | { "DROID": Droid } };
...
export type Codex = { append_prompt: AppendPrompt, sandbox?: SandboxMode | null, ask_for_approval?: AskForApproval | null, oss?: boolean | null, model?: string | null, model_reasoning_effort?: ReasoningEffort | null, model_reasoning_summary?: ReasoningSummary | null, model_reasoning_summary_format?: ReasoningSummaryFormat | null, 
/**
 ...
 */
profile?: string | null, base_instructions?: string | null, 
/**
 * Deprecated: no v2 equivalent. Kept as a no-op so stored profiles that
 * set it keep deserializing.
 */
include_apply_patch_tool?: boolean | null, model_provider?: string | null, 
/**
 * Deprecated: no v2 equivalent. Kept as a no-op so stored profiles that
 * set it keep deserializing.
 */
compact_prompt?: string | null, developer_instructions?: string | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };
...
export type QualityGateMode = "off" | "shadow" | "warn" | "enforce";
...
export type ProvidersConfig = { rust: boolean, frontend: boolean, repo: boolean, security: boolean, sonar: boolean, 
/**
 * Built-in Rust static analysis rules
 */
builtin_rust: boolean, 
/**
 * Built-in TypeScript/JavaScript static analysis rules
 */
builtin_frontend: boolean, 
/**
 * Built-in language-agnostic rules (duplication, secrets, etc.)
 */
builtin_common: boolean, 
/**
...
export type QualityPolicyResponse = { 
/**
