...
export function MultiFileSearchTextarea({
  ...
  const getDropdownPosition = () => {
    ...
    if (finalLeft + dropdownWidth > globalThis.window.innerWidth - 16) {
      finalLeft = globalThis.window.innerWidth - dropdownWidth - 16;
    }
    ...
    const availableSpaceBelow = globalThis.window.innerHeight - textareaRect.bottom - 32;
        ...
        createPortal(
          ...
          >
            {isLoading ? (
              ...
              <div className="py-1" role="listbox" aria-label="Search results"> {/* NOSONAR: custom listbox with role="option" children; native <datalist> lacks the required styling/interaction control */}
