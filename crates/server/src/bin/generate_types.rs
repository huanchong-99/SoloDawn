...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::config::McpConfigError::decl(),
        ...
        server::routes::terminal_ws::WsMessage::decl(),
        ...
        services::services::config::WorkflowModelLibraryItem::decl(),
        ...
        // [P3-G3] Quality-gate policy config + catalog DTOs (server has `quality` dep).
